...
OBJS+=mediatypes/PiMediaItem.o
OBJS+=mediatypes/PiMediaTextGFX.o mediatypes/PiMediaTextXML.o
OBJS+=mediatypes/PiMediaImageGFX.o mediatypes/PiMediaImageXML.o 
...
INCLUDES+= -I${BR_DIR}/output/staging/usr/include/libxml2
